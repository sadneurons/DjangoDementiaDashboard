...
output_file('Absolute_care_home_beds_bokeh.html',
            title="Absolute numbers of care home beds per borough")
#fig = figure()
...
fig = figure(#text_align="center",
             ...
             y_axis_label='Care home beds per GM borough',
             y_axis_type='linear',
             y_axis_location='left',
             y_range=(1000, 3500),
             title='Absolute numbers of care home beds for GM CCGs (click labels to hide CCG)',
