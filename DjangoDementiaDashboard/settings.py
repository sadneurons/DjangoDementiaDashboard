"""
Django settings for DjangoDementiaDashboard project.
...
SECRET_KEY = '9*3a&8eu3h*s8h2&gw(e7v8s^utxw9$)xd*t0f02q!nxb$hic%'
...
ROOT_URLCONF = 'DjangoDementiaDashboard.urls'
...
WSGI_APPLICATION = 'DjangoDementiaDashboard.wsgi.application'
